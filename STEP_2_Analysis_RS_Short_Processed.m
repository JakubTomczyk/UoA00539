...
%% Analysis of RS files from Processed_RS_BCST_RMET folder
...
for iComp = 1:3
    ...
    for jMeasure = 1:size(measureName, 2)
        ...
        title(strrep(['Processed_RS_Short, ', computerName{iComp}, ', ', measureName{jMeasure}], ...
            '_', '\_'))

        % Save results
        saveas(gcf, ['../Results/Processed_RS_Short_', computerName{iComp}, '_' ...
