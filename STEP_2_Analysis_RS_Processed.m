% In this script we perform EDA and statistical analysis of RS processed
% files
% Epoch length: 30 seconds

%% Analysis of _RS_Processed.xlsx files
...
for iComp = 1:3
    ...
    for jMeasure = 1:size(measureName, 2)
        ...
        title(strrep(['Processed_RS, ', computerName{iComp}, ', ', measureName{jMeasure}], ...
            '_', '\_'))

        % Save results
        saveas(gcf, ['../Results/Processed_RS_', computerName{iComp}, '_' ...
